...
public class ISTRING_RIGHTValueConverter extends AbstractLexerBasedConverter<String> {
	...
	public String toValue(String literal, INode node) {
		...
		try {
			...
			if (literal.startsWith(PRE) && literal.endsWith(POST)) {
				...
				throw new ValueConverterWithValueException("Malformed string literal (ISTRING_RIGHT)", node, "", null);
			}
