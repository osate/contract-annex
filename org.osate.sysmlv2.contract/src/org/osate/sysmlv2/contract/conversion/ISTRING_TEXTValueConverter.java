...
public class ISTRING_TEXTValueConverter extends AbstractLexerBasedConverter<String> {
	...
	public String toValue(String literal, INode node) {
		...
		try {
			...
			if (literal.startsWith(PRE) && literal.endsWith(POST)) {
				...
				throw new ValueConverterWithValueException("Malformed string literal (ISTRING_TEXT)", node, "", null);
			}
