...
public final class SupportedDispatchProtocolsType implements Type {
	public static final SupportedDispatchProtocolsType INSTANCE = new SupportedDispatchProtocolsType();
	private static final Map<String, Member> MEMBERS;

	static {
		MEMBERS = new LinkedHashMap<>();
		// getters for the value / unit / unit conversion
//		members.put("is", new IsMember());  -- From enumeration type
	}

	public SupportedDispatchProtocolsType() {
	}
	...
	public String toString() {
		return "SupportedDispatchProtocols";
	}
