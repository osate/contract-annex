...
public class ContractSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_TerminalExpression(ISerializationContext context, NameReference semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getTerminalExpressionAccess().getReferenceElementIDTerminalRuleCall_3_1_0_1(), semanticObject.eGet(ContractPackage.Literals.NAME_REFERENCE__REFERENCE, false));
		feeder.finish();
	}
