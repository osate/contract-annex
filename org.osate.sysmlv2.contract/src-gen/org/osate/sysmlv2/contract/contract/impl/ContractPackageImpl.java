...
import org.osate.sysmlv2.contract.contract.Predefined;
...
public class ContractPackageImpl extends EPackageImpl implements ContractPackage
{
   ...
   * @see org.osate.sysmlv2.contract.contract.ContractPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    singleValDeclarationEClass.getESuperTypes().add(theSysMLPackage.getElement());
    singleValDeclarationEClass.getESuperTypes().add(this.getQuery());
    tupleNameEClass.getESuperTypes().add(theSysMLPackage.getElement());
    singleParameterEClass.getESuperTypes().add(theSysMLPackage.getElement());
    ...
    initEReference(getPropertyLookup_Right(), theSysMLPackage.getAttributeDefinition(), null, "right", null, 0, 1, PropertyLookup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
