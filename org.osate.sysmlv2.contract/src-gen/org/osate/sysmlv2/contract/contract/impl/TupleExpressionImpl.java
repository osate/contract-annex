 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.sysmlv2.contract.contract.impl.TupleExpressionImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleExpressionImpl extends ExpressionImpl implements TupleExpression
{
  ...
  {
    return ContractPackage.Literals.TUPLE_EXPRESSION;
  }
  ...
  public EList<Expression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Expression>(Expression.class, this, ContractPackage.TUPLE_EXPRESSION__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ContractPackage.TUPLE_EXPRESSION__ELEMENTS:
