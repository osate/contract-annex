...
public class ContractLibraryImpl extends ElementImpl implements ContractLibrary
{
  ...
  public EList<ContractElement> getContractElements()
  {
    ...
    {
      contractElements = new EObjectContainmentEList<ContractElement>(ContractElement.class, this, ContractPackage.CONTRACT_LIBRARY__CONTRACT_ELEMENTS);
    }
