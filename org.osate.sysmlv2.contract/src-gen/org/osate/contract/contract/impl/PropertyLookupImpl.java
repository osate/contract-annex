 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.contract.contract.impl.PropertyLookupImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.osate.contract.contract.impl.PropertyLookupImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyLookupImpl extends ExpressionImpl implements PropertyLookup
{
  ...
  public Property getRight()
  {
    if (right != null && ((EObject)right).eIsProxy())
    {
      ...
      right = (Property)eResolveProxy(oldRight);
      if (right != oldRight)
      {
        if (eNotificationRequired())
