...
public class ExecutePlanHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		} else if (selection instanceof SystemInstance) {
			component = (SystemInstance) selection;
		} else {
...
//		processor.processContract(component);
		linkConsole(event);
		processor.processVerificationPlan(component, false);
		unlinkConsole();
		return null;
	}
