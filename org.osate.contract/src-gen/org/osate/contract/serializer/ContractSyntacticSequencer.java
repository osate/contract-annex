...
public class ContractSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     componentImplementation=[ComponentImplementation|QCREF] ';' 'claims' (ambiguity) claims+=Source
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     componentImplementation=[ComponentImplementation|QCREF] ';' 'domains' (ambiguity) domains+=[Domain|QPREF]
	 ...
	 *     (rule start) (ambiguity) 'root' (rule start)
	 *     (rule start) (ambiguity) 'self' (rule start)
	 *     (rule start) (ambiguity) reference=[NamedElement|ID]
	 ...
	 *     componentImplementation=[ComponentImplementation|QCREF] ';' 'contracts' (ambiguity) contracts+=[Contract|QPREF]
	 ...
	 *     componentImplementation=[ComponentImplementation|QCREF] ';' (ambiguity) '}' (rule end)
	 *     domains+=[Domain|QPREF] ';'+ (ambiguity) '}' (rule end)
