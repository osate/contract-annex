...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Single Sys ML Declaration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.osate.contract.contract.impl.SingleSysMLDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.osate.contract.contract.impl.SingleSysMLDeclarationImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link org.osate.contract.contract.impl.SingleSysMLDeclarationImpl#getOwnedPropertyAssociations <em>Owned Property Association</em>}</li>
 *   <li>{@link org.osate.contract.contract.impl.SingleSysMLDeclarationImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SingleSysMLDeclarationImpl extends QueryImpl implements SingleSysMLDeclaration
{
  /**
   ...
   * @generated
   */
  protected SingleSysMLDeclarationImpl()
  {
    super();
  }
  ...
  {
    return ContractPackage.Literals.SINGLE_SYS_ML_DECLARATION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired()) {
		eNotify(new ENotificationImpl(this, Notification.SET, ContractPackage.SINGLE_SYS_ML_DECLARATION__NAME, oldName, name));
	}
  }
  ...
  public EList<PropertyAssociation> getOwnedPropertyAssociations()
  {
    ...
    {
      ownedPropertyAssociations = new EObjectContainmentEList<PropertyAssociation>(PropertyAssociation.class, this, ContractPackage.SINGLE_SYS_ML_DECLARATION__OWNED_PROPERTY_ASSOCIATION);
    }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired()) {
		eNotify(new ENotificationImpl(this, Notification.SET, ContractPackage.SINGLE_SYS_ML_DECLARATION__VALUE, oldValue, value));
	}
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ContractPackage.SINGLE_SYS_ML_DECLARATION__OWNED_PROPERTY_ASSOCIATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ContractPackage.SINGLE_SYS_ML_DECLARATION__NAME:
        return getName();
      case ContractPackage.SINGLE_SYS_ML_DECLARATION__QUALIFIED_NAME:
        return getQualifiedName();
      case ContractPackage.SINGLE_SYS_ML_DECLARATION__OWNED_PROPERTY_ASSOCIATION:
        return getOwnedPropertyAssociations();
      case ContractPackage.SINGLE_SYS_ML_DECLARATION__VALUE:
        return getValue();
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == NamedElement.class)
    {
      ...
      {
        case ContractPackage.SINGLE_SYS_ML_DECLARATION__NAME: return Aadl2Package.NAMED_ELEMENT__NAME;
        case ContractPackage.SINGLE_SYS_ML_DECLARATION__QUALIFIED_NAME: return Aadl2Package.NAMED_ELEMENT__QUALIFIED_NAME;
        case ContractPackage.SINGLE_SYS_ML_DECLARATION__OWNED_PROPERTY_ASSOCIATION: return Aadl2Package.NAMED_ELEMENT__OWNED_PROPERTY_ASSOCIATION;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == NamedElement.class)
    {
      ...
      {
        case Aadl2Package.NAMED_ELEMENT__NAME: return ContractPackage.SINGLE_SYS_ML_DECLARATION__NAME;
        case Aadl2Package.NAMED_ELEMENT__QUALIFIED_NAME: return ContractPackage.SINGLE_SYS_ML_DECLARATION__QUALIFIED_NAME;
        case Aadl2Package.NAMED_ELEMENT__OWNED_PROPERTY_ASSOCIATION: return ContractPackage.SINGLE_SYS_ML_DECLARATION__OWNED_PROPERTY_ASSOCIATION;
        default: return -1;
      }
    }
    if (baseClass == SingleDeclaration.class)
