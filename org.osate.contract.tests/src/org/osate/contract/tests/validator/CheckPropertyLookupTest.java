...
public class CheckPropertyLookupTest {
	private static final String PATH = "org.osate.contract.tests/models/validator/CheckPropertyLookupTests/";
	...
	public void testInvalidLookup() {
		var pkg = testHelper.parseFile(PATH + "invalid_lookup.aadl");
		...
		with(issues.get(0), issue -> {
			...
			assertEquals("Cannot lookup property on a String", issue.getMessage());
