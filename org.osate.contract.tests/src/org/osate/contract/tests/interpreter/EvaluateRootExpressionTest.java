...
public class EvaluateRootExpressionTest {
	private static final String PATH = "org.osate.contract.tests/models/interpreter/EvaluateRootExpressionTests/";
	...
	public void testRootExpression() throws Exception {
		var pkg = testHelper.parseFile(PATH + "root_expression_test.aadl");
