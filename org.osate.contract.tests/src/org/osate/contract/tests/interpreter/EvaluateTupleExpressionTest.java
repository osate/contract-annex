...
public class EvaluateTupleExpressionTest {
	private static final String PATH = "org.osate.contract.tests/models/interpreter/EvaluateTupleExpressionTests/";
	...
	public void testTupleExpression() throws Exception {
		var pkg = testHelper.parseFile(PATH + "tuple_expression_test.aadl");
		...
		assertIterableEquals(List.of("s_i_Instance", ComponentCategory.SYSTEM),
				((Tuple) result.get("v1")).getElements());
	}
}