...
public class EvaluateTupleDeclarationTest {
	private static final String PATH = "org.osate.contract.tests/models/interpreter/EvaluateTupleDeclarationTests/";
	...
	public void testTuple() throws Exception {
		var pkg = testHelper.parseFile(PATH + "tuple_test.aadl");
		...
		assertEquals("s_i_Instance", result.get("v1"));
		assertEquals(ComponentCategory.SYSTEM, result.get("v2"));
	}
}