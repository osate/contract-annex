...
public class SingleValDeclarationTest {
	private static final String PATH = "org.osate.contract.tests/models/typeSystem/SingleValDeclarationTests/";
	...
	@Test
	public void testSingleValDeclaration() {
		var pkg = testHelper.parseFile(PATH + "single_val_declaration_test.aadl");
		...
		with(contract.getQueries().get(0), query -> {
			var type = typeSystem.namedType((SingleValDeclaration) query).getValue();
