...
public class SingleParameterTest {
	private static final String PATH = "org.osate.contract.tests/models/typeSystem/SingleParameterTests/";
	...
	public void testSingleParameter() {
		var pkg = testHelper.parseFile(PATH + "single_parameter_test.aadl");
