...
public class TupleExpressionTest {
	private static final String PATH = "org.osate.contract.tests/models/typeSystem/TupleExpressionTests/";
	...
	public void testTupleExpression() {
		...
		with(contract.getQueries().get(0), query -> {
			...
			assertEquals("(ComponentInstance, String, ComponentCategory)", type.toString());
		});
	}
}