...
public class BooleanExpressionTest {
	private static final String PATH = "org.osate.contract.tests/models/typeSystem/BooleanExpressionTests/";
	...
	public void testBooleanExpression() {
		var pkg = testHelper.parseFile(PATH + "boolean_expression_test.aadl");
